...
_p[0] = {
     ...
     */
        ...
        function KMEditor(selector, option) {
...
_p[6] = {
    value: function(require, exports, module) {
        ...
        function FSM(defaultState, minder) {
            var currentState = defaultState;
            var preState = defaultState;
            var BEFORE_ARROW = " - ";
            var AFTER_ARROW = " -> ";
            var handlers = [];
            /**
        ...
        function FSMRumtime() {
            this.fsm = new FSM("normal", this.minder);
        }
    ...
    value: function(require, exports, module) {
        ...
        function NodeRuntime() {
            ...
            var defaultButtons = {
                ...
                ring: {
                    button: [ "前移:Alt+Up:ArrangeUp", "下级:Tab:AppendChildNode", "同级:Enter:AppendSiblingNode", "后移:Alt+Down:ArrangeDown", "删除:Delete|Backspace:RemoveNode", "归纳:Shift+Tab|Shift+Insert:AppendParentNode", "整理:Ctrl+R:ResetLayout" ]
                },
                top: {
                    button: [ "超链接:H:input|hyperLink", "图片:I:input|image", "备注:N:input|note", "优先级:P:next|priority", "进度:G:next|progress", "资源:R:input|resource" ],
                    subMenu: {
                        priority: {
                            ring: {
                                button: [ "1级:1:priority|1", "2级:2:priority|2", "3级:3:priority|3", "4级:4:priority|4", "5级:5:priority|5", "6级:6:priority|6", "7级:7:priority|7", "8级:8:priority|8", "9级:9:priority|9" ]
                            },
                            center: {
                        ...
                        progress: {
                            ring: {
                                button: [ "未开始:0:progress|1", "1/8:1:progress|2", "2/8:2:progress|3", "3/8:3:progress|4", "4/8:4:progress|5", "5/8:5:progress|6", "6/8:6:progress|7", "7/8:7:progress|8", "8/8:8:progress|9" ]
                            },
                            center: {
                ...
                bottom: {
                    button: [ "模板:T:next|theme", "布局:L:next|template", "样式:S:next|style", "展开:/:Expand", "放大:+|=:zoomin", "缩小:-:zoomout" ],
                    subMenu: {
                        theme: {
                            bottom: {
                                button: [ "紧凑经典::theme|classic-compact", "紧凑天盘::theme|tianpan-compact", "紧凑冷光::theme|snow-compact", "紧凑蓝::theme|fresh-blue-compat", "紧凑绿::theme|fresh-green-compat", "紧凑粉::theme|fresh-pink-compat", "紧凑紫::theme|fresh-purple-compat", "紧凑红::theme|fresh-red-compat", "紧凑黄::theme|fresh-soil-compat", "线框::theme|wire" ]
                            },
                            center: {
                                button: [ "返回:Esc:next|back" ]
                            },
                            top: {
                                button: [ "脑图经典::theme|classic", "经典天盘::theme|tianpan", "温柔冷光::theme|snow", "天空蓝::theme|fresh-blue", "文艺绿::theme|fresh-green", "脑残粉::theme|fresh-pink", "浪漫紫::theme|fresh-purple", "清新红::theme|fresh-red", "泥土黄::theme|fresh-soil", "鱼骨图::theme|fish" ]
                            }
                        },
                        template: {
                            top: {
                                button: [ "思维导图:S:template|default", "组织结构图:O:template|structure", "目录组织图:M:template|filetree" ]
                            },
                            center: {
                                button: [ "返回:Esc:next|back" ]
                            },
                            bottom: {
                                button: [ "逻辑结构图:L:template|right", "鱼骨图:F:template|fish-bone", "天盘图:T:template|tianpan" ]
                            }
                        }
                    }
                }
    ...
    value: function(require, exports, module) {
        var tools = {
            createViewNavigator: function() {
                ...
                var $previewNavigator = $("<div>").addClass("preview-navigator").appendTo("#minder-editor");
                // 画布，渲染缩略图
                ...
                function updateContentView() {
                    ...
                    contentView = view;
                    var padding = 30;
                    paper.setViewBox(view.x - padding - .5, view.y - padding - .5, view.width + padding * 2 + 1, view.height + padding * 2 + 1);
                    var nodePathData = [];
            ...
            function _activeState(name, position) {
                ...
                if (name == IDLE) {
                    ...
                    if (_currentState != IDLE) {
                        ...
                        if (_currentState) {
                            _currentState.active(this.prePosition);
                        } else {
                            _currentState = "idle";
                        }
                    }
                    ...
                    position = position || this.prePosition;
        ...
        function HotBoxState(hotBox, stateName) {
            ...
            function layout() {
                ...
                function layoutRadius() {
                    if (buttons.ring.length > 0) {
                        return buttons.ring.length * 15;
                    } else {
                        if (buttons.center) {
                            return 45;
                        } else if (buttons.top.length == 0 || buttons.bottom.length == 0) {
                            return 0;
                        } else {
                            return 15;
                        }
            ...
            function defaultButtonRender(format, option) {
                var html;
                if (option.key) {
                    html = '<span class="label">{label}</span><span class="key">{key}</span>';
                } else {
...
//lib/km-core/src/connect/arc_tp.js
/**
 *
 * 圆弧连线
 *
...
//lib/km-core/src/core/browser.js
/**
 * 提供浏览器检测的模块
 * @unfile
 * @module KM.browser
	 ...
	 */
        var MinderNode = kity.createClass("MinderNode", {
            ...
            equals: function(node, ignoreSelected) {
                ...
                for (var i = 0, ci; ci = me.children[i]; i++) {
...
//lib/km-core/src/layout/tianpan.js
/**
 * @fileOverview
 *
 * 天盘模板
...
//lib/km-core/src/module/editor.js
_p[71] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var Module = _p.r(45);
...
//lib/km-core/src/module/editor_keyboard.js
_p[72] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var utils = _p.r(58);
...
//lib/km-core/src/module/editor_range.js
_p[73] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var utils = _p.r(58);
...
//lib/km-core/src/module/editor_receiver.js
_p[74] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var utils = _p.r(58);
...
//lib/km-core/src/module/editor_selection.js
_p[75] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var utils = _p.r(58);
...
//lib/km-core/src/module/paste.js
_p[86] = {
    value: function(require, exports, module) {
        var kity = _p.r(42);
        var utils = _p.r(58);
...
//lib/km-core/src/template/tianpan.js
/**
 * @fileOverview
 *
 * 天盘模板
...
//lib/km-core/src/theme/tianpan.js
_p[110] = {
    value: function(require, exports, module) {
        var theme = _p.r(57);
